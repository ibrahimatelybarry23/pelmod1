...
In generale si ha $\text{size} \leq \text{capacity}$:
...
\begin{itemize}
    ...
    \item \inlinecode{v.at(i)}: restituisce il riferimento all'elemento
          in posizione \inlinecode{i}, controllandone i limiti.
...
\begin{tikzpicture}
    ...
    \node[right] at (0.4,0) {Ordinato (sotto soglia)};
    \node[draw, fill=confronto, minimum width=0.6cm, minimum height=0.6cm, rounded corners=2pt] at (4.5,0) {};
    \node[right] at (4.9,0) {Confronto};
    \node[draw, fill=scambio, minimum width=0.6cm, minimum height=0.6cm, rounded corners=2pt] at (7.5,0) {};
    \node[right] at (7.9,0) {Scambio};
    \node[draw, fill=neutro, minimum width=0.6cm, minimum height=0.6cm, rounded corners=2pt] at (10.0,0) {};
    \node[right] at (10.4,0) {Disordinato};
\end{tikzpicture}
