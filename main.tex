...
% --- Stile Codice ---
\definecolor{funcpurple}{rgb}{0.5, 0, 0.5}
\definecolor{typeteal}{RGB}{0, 139, 139}
\definecolor{memberred}{RGB}{180, 50, 50}
\lstdefinestyle{exactstyle}{
    ...
    morekeywords=[3]{List, cell},
    keywordstyle={[3]\color{typeteal}\bfseries},
    morekeywords=[4]{head},
    keywordstyle={[4]\color{memberred}},
}
...
\input{topic/Vettori e stringhe}


\chapter{Ricorsione}
\input{topic/Ricorsione}
\chapter{Classi}
\input{topic/Classi}
